...
const Header = ({userAuth,setUserAuth}) => {
    ...
    async function checkCode() {
        ...
        try {
            const response = await axios.post(metadata.url + '/user/code/check', data);
            ...
            <div className={classes.header__row}>
                ...
                <div className={classes.header__nav}>
                    <div style={{marginLeft: '20px'}}>
                        <NavButton className={classes.header__nav__item} style={{marginLeft:'0px'}} onClick=
                            {
                            showFavorite ?
                    ...
                    <div>
                        <NavButton className={classes.header__nav__item} onClick={userAuth ? () => {router.push('/profile')} : () => {setModalActive(true)}}>
                        ...
                        <Modal modalActive={modalActive} setModalActive={setModalActive}>
                            ...
                            <ModalDiv>
                                ...
                                <InputMask className={'input__mask'} id={'tel'} mask="+7 (___) ___-__-__" name={'tel'} replacement={{ _: /\d/ }} placeholder={'+7 (___) ___-__-__'}/>
                            </ModalDiv>
                            {modalCode ?
                                <ModalDiv>
