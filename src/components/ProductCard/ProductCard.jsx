        ...
        <div className={classes.card}>
            ...
            <div className={classes.card__body}>
                ...
                <div className={classes.card__row}>
                    <MyButton onClick={favoriteItems[product.id] ? () => removeProductFromFavorite(product.id)  : () => addProductToFavorite(product)}>
                        <img className={classes.card__row__img} src={favoriteItems[product.id] ? "/heart.png" : "/favorites.png"} alt="Избранное"/>
                    </MyButton>
